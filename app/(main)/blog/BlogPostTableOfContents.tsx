...
const parseOutline = (nodes: Node[] | null | undefined) => {
...
export function BlogPostTableOfContents({ headings }: { headings: Node[] | null | undefined }) {
  ...
  React.useEffect(() => {
    if (outline.length === 0) return // 没有标题时不需要添加滚动监听
